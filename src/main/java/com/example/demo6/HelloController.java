...
public class HelloController {
    ...
    @FXML
    private void handleIncomeAction(ActionEvent event) {
        performAction(new IncomeAction(currentPlayer));
    }

    @FXML
    private void handleForeignAidAction(ActionEvent event) {
        performAction(new ForeignAidAction(currentPlayer, opponent));
    }

    @FXML
    private void handleCoupAction(ActionEvent event) {
        performAction(new CoupAction(currentPlayer, opponent));
    }

    @FXML
    private void handleTaxAction(ActionEvent event) {
        performAction(new TaxAction(currentPlayer, opponent));
    }

    @FXML
    private void handleAssassinateAction(ActionEvent event) {
        performAction(new AssassinateAction(currentPlayer, opponent));
    }

    @FXML
    private void handleStealAction(ActionEvent event) {
        performAction(new StealAction(currentPlayer, opponent));
    }

    @FXML
    private void handleSwapAction(ActionEvent event) {
    ...
    private void performAction(Action action) {
        ...
        updatePlayerInfo();
        updateActionButtons();
        // TODO: Handle challenges, blocks, and other player interactions using the GUI
    }
}